package com.laioffer.newsapp.ui.save;
...
import com.laioffer.newsapp.databinding.SavedNewsItemBinding;
...
public class SavedNewsAdapter extends RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder> {
    // define an interface and private instance of listener and a setter
    // interface in the top, then private variables, last functions
    interface ItemCallback {
        void onOpenDetails(Article article);// if click item -> open detail page
        void onRemoveFavorite(Article article);//remove articles in the saved db
    }
