...
import com.laioffer.newsapp.databinding.FragmentSearchBinding;
import com.laioffer.newsapp.repository.NewsRepository;
import com.laioffer.newsapp.repository.NewsViewModelFactory;
...
public class SearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //return view --> inflate
        binding = FragmentSearchBinding.inflate(inflater, container, false); //false是为了避免重复
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // listener of text in search bar
        binding.newsSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                binding.newsSearchView.clearFocus(); // clearFocus
                return true;
            }
        ...
        NewsRepository repository = new NewsRepository(view.getContext());
